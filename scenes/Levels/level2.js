...
export class Level2 extends BaseLevel {
  ...
  preload() {
    ...
    this.load
      ...
      .image("canonball", "../assets/images/levelScenes/level2/canonball.png")
      .image("bullet", "../assets/images/levelScenes/level2/bullet.png")
      .image(
        "arkanoidlvl2",
        "../assets/images/levelScenes/level2/level2Ark.png"
      )
      .spritesheet(
        "fireball",
  ...
  create() {
    ...
    this.physics.add.collider(
      this.fireball.get(),
      this.cloud.getGroup1(),
      this.cloud.cloudImpact,
      null,
      this
    );
    this.physics.add.collider(
      this.fireball.get(),
      this.cloud.getGroup2(),
      this.cloud.cloudImpact,
      null,
      this
    );
    ...
    this.physics.add.collider(
      this.fireball.get(),
      this.bullet1.getBullet(),
      this.bullet1.bulletImpact,
      null,
      this
    );
    this.physics.add.collider(
      this.fireball.get(),
      this.bullet2.getBullet(),
      this.bullet2.bulletImpact,
      null,
      this
    );
